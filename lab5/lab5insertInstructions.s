...
#---------------------------------------------------------------
# Add the insertInstruction function to find the liveness or weather the registers 
# are dead for a specific instruction. The code makes adjustments to accurately
# determine the target address of control flow instructions to determine
# the target of jump and branch instrcutions.
# The subroutine automatically inserts the required instructions to save and restore
# the value of the registers into the binary representation of the program.
# 
