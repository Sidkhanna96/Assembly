...
poll:
	...
	beqz $s1, poll 			# loop until ready string 	4 	$a0 = address
...
# 	mfc0 $k0, $13
# 	andi $a1, $k1, 0x8000 		# Get the 15 byte value to check if timer interrupt happening
# 	srl $a1, $a1, 15			# shifting the value to the right to get the value at 15 position 
#  			# If value greater than zero then timer interrupt happened
